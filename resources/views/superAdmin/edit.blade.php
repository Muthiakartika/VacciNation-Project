...
@section('content')
    ...
    <div class="container-fluid">
        <!-- Page Heading -->
        <h3 class="mb-2 text-black">Reset Super Admin Password</h3>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{route('super-admin.update', $superAdmin->id)}}">
                    @csrf

                    <div class="form-group ">
                        <label for="name">Email</label>
                        <input id="name" type="text" class="form-control form-control-user"
                               name="email" value="{{$superAdmin->email}}" readonly>
                    </div>
                    ...
                    <div class="form-group">
                         ...
                         minlength="8" maxlength="64" required autocomplete="new-password" placeholder="Confirm Password">
                    </div>


                    <div class="form-group">
                        <a class="btn btn-primary" href="{{route('super-admins.index')}}">Back</a>
