...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('orthoc/images/favicon2.png')}}" type="">
...
<!-- owl slider -->
<script type="text/javascript" src="{{asset('orthoc/https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js')}}">
</script>
<!-- custom js -->
