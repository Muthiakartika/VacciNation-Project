...
<p>{{ $details['body'] }}</p>
@php
    // TAKING DATA FROM VACCINATION TABLE
...
<table style="width: 100%;">
    ...
    <tr>
        <td style="width: 14%;">Details</td>
        <td style="width: 2%;">:</td>
        <td style="width: 83%;">{{$vaccinations->remarks}}</td>
    </tr>
    </tbody>
</table>
<p>If there are any further changes toward the information,please wait for our response.</p>
