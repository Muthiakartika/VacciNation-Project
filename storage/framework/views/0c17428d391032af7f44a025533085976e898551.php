            ...
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo e(route('batches.store')); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <select type="text" class="form-control <?php $__errorArgs = ['vaccineName'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        <input class="form-control" type="hidden" name="qtyAdministered" value="0">
                    </div>

                    <div class="form-group">
                        <a class="btn btn-primary" href="<?php echo e(route('batches.index')); ?>">Back</a>
