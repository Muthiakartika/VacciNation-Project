        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('add-healthcare.store')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                <a class="btn btn-primary" href="<?php echo e(route('add-healthcare.index')); ?>">Back</a>
