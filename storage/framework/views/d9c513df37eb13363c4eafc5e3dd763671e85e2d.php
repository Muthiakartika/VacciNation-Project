...
<head>
    ...
    <title>VacciNation - Healthcare Administrator Dashboard</title>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; VacciNation 2022</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-warning" type="button" data-dismiss="modal" href="<?php echo e(route('logout')); ?>"
...
<?php /**PATH C:\xampp\htdocs\vaccination\resources\views/adminhealthcare/adminhealthcare-temp.blade.php ENDPATH**/ ?>
