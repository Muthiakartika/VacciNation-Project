                        ...
                        <form class="user" method="POST" action="<?php echo e(route('register')); ?>">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12 mb-3 mb-sm-0">
                                    <input id="nin" type="text" class="form-control  <?php $__errorArgs = ['nin'];
...
unset($__errorArgs, $__bag); ?>"  name="nin" value="<?php echo e(old('nin')); ?>"
                                           maxlength="20" placeholder="<?php echo e(__('NIN / Passport Number')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="name" maxlength="255" value="<?php echo e(old('name')); ?>" placeholder="<?php echo e(__('Full Name')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="address" value="<?php echo e(old('address')); ?>" placeholder="<?php echo e(__('Address')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="phone" minlength="10" maxlength="15" value="<?php echo e(old('phone')); ?>" placeholder="<?php echo e(__('Phone Number')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="dob" value="<?php echo e(old('dob')); ?>"
                                       placeholder="<?php echo e(__('Date of Birth')); ?>" >
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-sm-6">
                                    <input id="password-confirm" type="password" class="form-control"
                                           ...
                                           placeholder="<?php echo e(__('Confirm Passoword')); ?>">
                                </div>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\vaccination\resources\views/auth/register.blade.php ENDPATH**/ ?>