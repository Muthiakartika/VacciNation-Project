                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="<?php echo e(route('register')); ?>">
                                ...
                                <div class="form-group">
                                    <label for="nin" class="col-form-label "><?php echo e(__('NIN / Passport Number')); ?></label>
                                    <input id="nin" type="text" class="form-control form-control-user <?php $__errorArgs = ['nin'];
...
unset($__errorArgs, $__bag); ?>" name="nin">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group ">
                                    <label for="name" class="col-form-label text-md-end"><?php echo e(__('Full Name')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="address" type="text" class="form-control form-control-user <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    <label for="phone" class="col-form-label text-md-end"><?php echo e(__('Phone Number')); ?></label>
                                    <input id="phone" type="number" class="form-control form-control-user <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    <label for="dob" class=" col-form-label text-md-end"><?php echo e(__('Date of Birth')); ?></label>
                                    <input id="dob" type="date" class="form-control form-control-user <?php $__errorArgs = ['dob'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small text-success" href="<?php echo e(('login')); ?>">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vaccination\resources\views/auth/register.blade.php ENDPATH**/ ?>